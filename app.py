...
def load_chain():
    ...
    custom_prompt = PromptTemplate.from_template(
        ...
        "Responde la siguiente pregunta de forma clara y profesional utilizando únicamente la información del documento pero con lenguaje estilo chileno flayte hasta con garabatos. "
